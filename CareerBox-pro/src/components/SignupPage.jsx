...
function SignupPage() {
  return (
    ...
    >
      <form 
      autoComplete='off'
      className='w-1/3 bg-white py-5 px-7 rounded-2xl animate__animated animate__backInDown relative signup-form'
      >
        <i className="fas fa-times absolute top-5 right-5 text-xl text-gray-400 cursor-pointer"></i>
        <h1
        className='font-bold text-center text-3xl signup-heading'
        >Sign up</h1>
        ...
        <input
        className='my-2 w-full outline-0 py-1 pl-3 rounded-2xl border-2 border-blue-400 text-blue-600 signup-input'
        ...
        <div className="w-full flex justify-center items-center flex-col">
           <button 
        type='submit'
        className='px-6 py-1 font-bold mt-5 rounded signup-btn'
        >
          Sign up
        </button>
        <p className='add-text'>Already have an account!
